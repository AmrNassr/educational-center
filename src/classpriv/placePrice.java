...
public class placePrice extends javax.swing.JFrame {
 Connection con ;
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        if( id.getText().trim().isEmpty() && !price.getText().trim().isEmpty() )
                 ...
                 try
           {
               int amountt = Integer.parseInt(price.getText());
                 String sql111 = "INSERT INTO mrahmed.placeprice "
                         + "( placeprice, placename) VALUES ( '"+amountt+"', '"+cmclass.getSelectedItem().toString()+"')";
                        pst = (PreparedStatement)con.prepareStatement(sql111);
                        pst.execute();
                        JOptionPane.showMessageDialog(null, "تم ـم تسجيل دخل المعهد بنجاح");
                        price.setText("");
        ...
        if(!id.getText().trim().isEmpty() && !price.getText().trim().isEmpty())
        {
            try {
                ...
                int amountt = Integer.parseInt(price.getText());
                String sqll = "UPDATE mrahmed.placeprice SET placeprice = '"+amountt+"' WHERE idplaceprice = '"+id.getText()+"'";
                pst=(PreparedStatement) con.prepareStatement(sqll);
                pst.executeUpdate();
                JOptionPane.showMessageDialog(rootPane, "تم تعديل بيانات دخل المعهد بنجاح");
                price.setText("");
                cmclass.setSelectedIndex(0);
          ...
          public void comboxfromcombo1()
      {
            ...
            public void itemStateChanged(ItemEvent event) {
                ...
                Object item = event.getItem();
                     try {
             String sql="SELECT placeprice  FROM mrahmed.placeprice "
                     + "where placename='"+cmclass.getSelectedItem().toString()+"'";
             pst=(PreparedStatement) con.prepareStatement(sql);
             rs=pst.executeQuery();
             while(rs.next()){
                 price.setText(rs.getString("placeprice"));
                ...
                if (event.getStateChange() == ItemEvent.DESELECTED) {
                     ...
                     try{
                         ...
                         {
                             String sql="SELECT idplaceprice  FROM mrahmed.placeprice where placename='"+cmclass.getSelectedItem().toString()+"'";
             pst=(PreparedStatement) con.prepareStatement(sql);
             rs=pst.executeQuery();
             while(rs.next()){
                 id.setText(rs.getString("idplaceprice"));
                 price.setText("");
             }
                         }
                     }
