...
public class addclass extends javax.swing.JFrame {
  Connection con ;  
    ...
    private void initComponents() {
        ...
        jPanel1.add(name2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 100, 250, 30));
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        if( name2.getText().trim().isEmpty() )
            {
                JOptionPane.showMessageDialog(this, " من فضلك ادخل اسم السنه الصف");
            }
            else
            {
                ...
                if(dialogResult == 0) {
                    try{
                        //INSERT INTO `mrahmed`.`class` (`classname`) VALUES ('x');

                        String sql = "INSERT INTO mrahmed.class  (classname) VALUES('"+name2.getText()+"')";
                        pst = (PreparedStatement)con.prepareStatement(sql);
                        pst.execute();
                        JOptionPane.showMessageDialog(null, "تم اضافه الصف بنجاح");
                        name2.setText("");
