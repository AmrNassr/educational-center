 ...
 * @author amnassar
 */
public final class bookgroup extends javax.swing.JInternalFrame {
...
headerLabel.setHorizontalAlignment(JLabel.CENTER);
    ...
    private void initComponents() {
        ...
        jPanel10.add(cmday, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 60, 230, 30));

        cmplace.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " " }));
        jPanel10.add(cmplace, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 160, 230, 30));
        ...
        jPanel10.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 240, 180, 40));

        cmyear.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " ", "2020", "2021", "2023", "2024", "2025", "2026", "2027", "2028", "2029" }));
        jPanel10.add(cmyear, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 210, 80, 30));

        jLabel13.setBackground(new java.awt.Color(255, 255, 255));
        jLabel13.setFont(new java.awt.Font("Arial", 1, 30)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("السنه");
        jPanel10.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 210, 70, -1));

        jLabel10.setBackground(new java.awt.Color(255, 255, 255));
        jLabel10.setFont(new java.awt.Font("Arial", 1, 30)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("المكان");
        jPanel10.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 160, -1, -1));

        jLabel8.setBackground(new java.awt.Color(255, 255, 255));
        jLabel8.setFont(new java.awt.Font("Arial", 1, 30)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("اليوم");
        jPanel10.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 60, 50, -1));

        time.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel10.add(time, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 110, 230, 30));
        ...
        jPanel10.add(التوقيت, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 110, 170, -1));
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        if(userid.getText().trim().isEmpty())
        {
            ...
            String year=cmyear.getSelectedItem().toString();
            ...
            else
            {
                ...
                String dayandtime=""+day+""+timee;
                try
                {
                     String sqll1 = "SELECT dayandtime FROM mrahmed.groups Where dayandtime='"+dayandtime+"' and type='حجز' ";
            ...
            rs=pst.executeQuery();
                ...
                if(dialogResult == 0) {
                    try{
                        String sql = "INSERT INTO mrahmed.groups(GroupName,dayandtime,type,year) VALUES"
                        + " ('"+GroupName+"','"+dayandtime+"','حجز','"+year+"')";
                        ...
                        JOptionPane.showMessageDialog(null,"الرقم الوظيف الذي حاولت ادخاله موجود مسبقا");
                    }
   ...
   public void tablelord()
    {
        try {
            String sqll = "SELECT idGroups, groupname FROM mrahmed.groups where type = 'حجز' ";
