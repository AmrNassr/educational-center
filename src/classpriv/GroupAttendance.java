...
public class GroupAttendance extends javax.swing.JFrame {
  Connection con ;  
 ...
 int dayy = cal.get(Calendar.DAY_OF_MONTH);
                ...
                AutoCompleteDecorator.decorate(cmgroup1);
              
                cmgroup1.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
    ...
    private void initComponents() {
        ...
        jLabel10.setText("مجموعه");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 20, 100, -1));
        ...
        jPanel1.add(cmgroup1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 20, 230, 30));
...
if(!cmgroup1.getSelectedItem().toString().trim().isEmpty())
{
    ...
    String to=year2.getText()+"-"+month2.getText()+"-"+day2.getText();
     InputStream in=null;
      try {
          ...
          String reportpath= "D:\\meal\\MrHossamReport\\groupfollowup.jasper";
